        ...
        <form className='flex flex-1 flex-col'>
            ...
            {imageUrlBoxIsOpen && (
                <form className='mt-5 flex rounded-lg bg-twitter/60 py-2 px-4'>
                    <input 
                    ref={imageInputRef}
                    className='flex-1 bg-transparent p-2 text-white outline-none placeholder:text-white' type="text" placeholder="Entrer Image URL..." 
                    />
                    <button type='submit' onClick={addImageToTweet} className='font-bold text-white'>Add Image
                    </button>
                </form>
            )}
